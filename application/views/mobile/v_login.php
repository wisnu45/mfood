	...
	<body class="o-page">
		<div id="page">
			...
			<div id="content">
				...
				<form class="contactForm" action="<?php echo base_url().'mobile/member/auth'?>" method="post">
					...
					<p>Jika Anda belum memiliki akun. Daftarkan akun anda disini. <a href="<?php echo base_url().'mobile/member/register'?>">Mendaftar</a></p>
