	...
	<body class="o-page">
		<div id="page">
			...
			<div id="content">
				...
				<form class="contactForm" action="<?php echo base_url().'mobile/konfirmasi/simpan_konfirmasi'?>" method="post" enctype="multipart/form-data">
					<input type="text" name="no_invoice" placeholder="No Invoice*" required>
					<input type="text" name="nama" placeholder="Nama*" required>
					<input type="text" name="bank" placeholder="Bank*" required>				
					<input type="number" name="jumlah" placeholder="Nominal*" required>
